...
- **Automatic NEPSE Holiday Calendar**: A scheduled GitHub Action syncs the official holiday listing into `holidays.json`; the manual closure field remains available for ad-hoc notices and offline fallback.
